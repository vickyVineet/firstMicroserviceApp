...
public class CustomerSpecificationsBuilder {
    ...
    public final CustomerSpecificationsBuilder with(String key, String operation, Object value,
                                                    String prefix, String suffix) {
        return with(null, key, operation, value, prefix, suffix);
    }

    public final CustomerSpecificationsBuilder with(String orPredicate, String key, String operation,
    ...
    public Specification<Customer> build() {
        ...
        Specification result = new CustomerSpecification(params.get(0));
